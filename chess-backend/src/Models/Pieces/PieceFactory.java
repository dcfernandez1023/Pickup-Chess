...
public class PieceFactory {
    ...
    public ArrayList<Piece> createAllPieces() {
        ...
        //white pieces
        Piece whiteRook1 = new ChessPiece(new int[]{0, 0}, "white", "Rook", "R");
        ...
        Piece whiteRook2 = new ChessPiece(new int[]{0, 7}, "white", "Rook", "R");
        ...
        Piece blackRook1 = new ChessPiece(new int[]{7, 0}, "black", "Rook", "R");
        ...
        Piece blackRook2 = new ChessPiece(new int[]{7, 7}, "black", "Rook", "R");
